...
if __name__ == "__main__":
  data = CondSeqResampleNet(sys.argv[1], num_neighbours=30, n_backrub=10)
  valid_data = CondTransformerNet(sys.argv[2], num_neighbours=30, n_backrub=0) # Validation with out augmentation
  net = DDP(# SDP(
